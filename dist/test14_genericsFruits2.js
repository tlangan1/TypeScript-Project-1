...
var fruitsFiltered = (0, test14_library_1.filterDict)(
  test14_data_1.fruits,
  (item) => item.mass > 100
);
console.log("Filtered:", fruitsFiltered);
var fruitsMapped = (0, test14_library_1.mapDict)(
  test14_data_1.fruits,
  (input, name) => {
    kg: input.mass / 1000, name;
  }
);
console.log("Mapped:", fruitsMapped);
var fruitsReduced = (0, test14_library_1.reduceDict)(
  test14_data_1.fruits,
  (init, input) => init + input.mass,
  0
);
...
const fruitsWithKgMass = (0, test14_library_1.mapDict)(
  test14_data_1.fruits,
  (fruit, name) =>
    Object.assign(Object.assign({}, fruit), { kg: 0.001 * fruit.mass, name })
);
...
// FILTER
// only red fruits
const redFruits = (0, test14_library_1.filterDict)(
  test14_data_1.fruits,
...
const oneOfEachFruitMass = (0, test14_library_1.reduceDict)(
  test14_data_1.fruits,
